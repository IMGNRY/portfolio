                    ...
                    <div class="picture-wrapper">
                        <transition>
                            <div
                                v-if="card.ready"
                                class="picture"
                                :style="{ 'background-image': `url(${urlFromImageId(card.imageIds[0])})` }"
                            ></div>
                        </transition>
                    </div>
                </v-intersect>
        ...
        this.cards = [
            {
                ...
                description:
                    'Subscription based Single Page Application SaaS to help everyday photographers to organize and enjoy their photos.',
                tags: [
                    'vue',
                    'typescript',
                    'html+css',
            ...
            },
            {
                ...
                description:
                    'Contracted by Great Works agency I built a dynamic product page with custom CMS for different grid style layouts.',
